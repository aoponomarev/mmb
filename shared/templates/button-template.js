 ...
 * ================================================================================================
 *
 * PURPOSE: Шаблон for универсального компонента кнопки (cmp-button) с поддержкой иконки, текста и суффикса.
 *
 ...
 * - Внутренний контейнер: ⟨span⟩ с классами d-flex, align-items-center, justify-content-center for layout
 ...
 * - Отступы между элементами: через CSS margin (не gap) for корректной работы с условным рендерингом
 * - Элементы суффикса sectionяются отступом ms-1 (кроме первого)
 * Условный рендеринг:
 ...
 * Responsiveness:
 * - Responsiveness управляется через CSS классы компонента .btn-responsive с вложенными селекторами
