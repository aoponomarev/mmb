...
- **Граф Казуальности:** Хэши (`#for-X`) связывают код с архитектурными правилами (скиллами). Скрипт #JS-eG4BUXaS (validate-causality-invariant.js) следит за тем, чтобы агент случайно не удалил хэш в одном месте, оставив в другом (защита от галлюцинаций).
