...
- [id:sk-a8c3e1](../is/skills/process-arch-change-during-plan.md) — Architecture Change During Plan Execution
...
- [id:sk-d599bd](../is/skills/arch-causality.md) — Architecture: Causality Traceability System
...
- [id:sk-dcc232](../is/skills/process-meta-causality-discovery.md) — Process: Meta-Causality Discovery & Application
...
- [id:sk-f4a2c8](../is/skills/mcp-causality-graph-tools.md) — MCP: Causality Graph Tools
