...
- id:doc-f8d4af (migration-roadmap.md): Master roadmap tracking all migration stages.
- id:doc-f1a4d3 (project-evolution.md): SSOT log of significant project milestones and decisions.
- id:docidx-0b048e (index-skills.md): Auto-generated index of all skills (updated by `npm run skills:index`).
- id:docidx-3022eb (index-ais.md): Auto-generated index of AIS specifications (updated by `npm run ais:index`).
