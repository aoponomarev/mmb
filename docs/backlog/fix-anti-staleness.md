...
- **Источник:** `npm run skills:batch-review` → #JS-y23qJxuC
- **SSOT конфигурации:** #JS-cMCNbcJ1 (path-contracts.js) — EXCLUDE_SOURCE_REL, SKIP_LINK_PATTERNS, resolvePath (общий с validate-skills).
...
- [x] **#JS-cMCNbcJ1** — SSOT для exclusions, skip patterns, resolvePath; validate-skills и validate-dead-links импортируют из контракта
...
- [ ] **4.5** #deprecated- in use — #JS-69pjw66d (validate-causality.js): warning при использовании #deprecated-X в коде
