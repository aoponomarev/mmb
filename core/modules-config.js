 ...
 * ================================================================================================
 * Skill: a/skills/app/skills/architecture/architecture-loading.md
 *
 ...
 *   Отдельный файл шаблона для них НЕ нужен.
 *
 * ВАЖНО:
 ...
 *
 * ССЫЛКА: Принципы модульной системы описаны в `a/skills/app/skills/architecture/`
 */
...
(function() {
    ...
    window.modulesConfig = {
        ...
        utilities: [
            ...
            // для перехвата всех логов с самого начала загрузки страницы
        ...
        core: [
            // I18n конфигурация (загружается первой, т.к. используется в tooltips и messages)
            {
                id: 'i18n-config',
            ...
            // Data Providers (для работы с внешними источниками данных о монетах)
            {
            ...
            },
            {
                ...
                deps: [],
                category: 'core'
                // Условие удалено - config нужен для auth и cloudSync
            },
            {
                id: 'postgres-config',
