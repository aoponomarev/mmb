...
// @skill-anchor security/skill-secrets-hygiene: API keys are injected via CI/CD env, not hardcoded here.
...
// @skill-anchor security/skill-secrets-hygiene: DB credentials injected via CI/CD env
