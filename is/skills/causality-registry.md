...
| `#for-modal-shell-uniformity` | advisory | All application modals should use one shell structure (`cmp-modal` + standard header composition + body component + modalApi-managed footer actions). Mixed ad-hoc modal markup creates inconsistent close behavior, spacing, and action placement. |
