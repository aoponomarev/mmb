...
- Baseline: `d4emhv3ro654rvleiggo`

## Added Keys

- `$.function.active_version.concurrency` = "1"
- `$.function.active_version.created_at` = "2026-03-11T11:59:43.040Z"
- `$.function.active_version.entrypoint` = "market-fetcher/index.handler"
...
- `$.function.active_version.id` = "d4e8el3pha490sonmles"
- `$.function.active_version.image_size` = "266240"
...
- `$.function_previous_version.created_at` = "2026-03-11T11:55:40.259Z"
...
- `$.function_previous_version.id` = "d4emhv3ro654rvleiggo"
